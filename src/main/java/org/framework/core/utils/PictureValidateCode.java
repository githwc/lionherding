...
public class PictureValidateCode {
     ...
     * @param height 图片高
     */
    public PictureValidateCode(int width, int height) {
        this.width = width;
        this.height = height;
        this.createCode();
    }
     ...
     */
    public PictureValidateCode(int width, int height, int codeCount, int lineCount) {
        this.width = width;
        this.height = height;
